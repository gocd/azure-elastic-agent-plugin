...
public class ServerRequestFailedException extends Exception {
  ...
  public static ServerRequestFailedException sendHealthMessages(GoApiResponse response) {
    return new ServerRequestFailedException(response, "send health messages");
  }
}
